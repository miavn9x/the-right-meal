                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <div className="grid grid-cols-12 gap-2 bg-[#2D3748] text-white p-2 md:p-3 items-center rounded-lg shadow-md min-h-[60px]">
                                                        ...
                                                        <div className="col-span-3 italic text-slate-400 text-left leading-tight">
                                                            Hỗ trợ phục hồi cơ bắp và giữ no lâu nhất sau bữa ăn. Rất tốt cho người tập thể thao/giữ dáng.
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    {/* Row 5 */}
                                                     <div className="grid grid-cols-12 gap-2 bg-[#2D3748] text-white p-2 md:p-3 items-center rounded-lg shadow-md min-h-[60px]">
                                                        ...
                                                        <div className="col-span-3 italic text-slate-400 text-left leading-tight">
                                                            Tuyệt vời để bổ sung vào bữa ăn chính để tăng thể tích mà không tăng nhiều Calo, hỗ trợ tiêu hóa.
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
